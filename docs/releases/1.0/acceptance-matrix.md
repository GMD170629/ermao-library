...
| IMP-04 / RG-02 | P2；IMP-01源保持不变 | 记录文件hash/拓扑/进度→再次手动扫描→对账 | 不重复不丢失，未变文件进度保留 | local-load/measurement-20260906-065525/rescan-integrity.json；详见evidence最新记录 | PARTIAL：复用c7f5d5eb真实FLAT三格式10k原件/拓扑/进度保留证据；VOLUMES及最终同RC仍待，不重跑大库 |

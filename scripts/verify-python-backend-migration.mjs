...
expectIncludes('apps/api-python/Dockerfile', 'python -m app.bootstrap.startup_data_migrations && exec uvicorn');
expectIncludes('apps/api-python/app/main.py', 'verify_startup_data_migrations_complete');
expectNotIncludes('apps/api-python/app/main.py', 'run_library_facet_index_data_migration');
expectNotIncludes('apps/api-python/app/main.py', 'run_comic_page_index_data_migration');
expectIncludes('apps/api-python/app/worker/main.py', 'verify_startup_data_migrations_complete');
expectNotIncludes('apps/api-python/app/worker/main.py', 'run_library_facet_index_data_migration');
expectNotIncludes('apps/api-python/app/worker/main.py', 'run_comic_page_index_data_migration');

...
expectIncludes('docker-compose.yml', 'MONITOR_ROOT: /monitor');
expectIncludes('docker-compose.prod.yml', 'MONITOR_ROOT: /monitor');
...
expectIncludes('deploy/fnos/app/docker/docker-compose.yaml', 'MONITOR_ROOT: /monitor');

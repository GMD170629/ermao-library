...
expectIncludes('apps/api-python/app/main.py', 'verify_current_schema');
expectIncludes('apps/api-python/app/worker/main.py', 'verify_current_schema');
...
expectIncludes('docker-compose.yml', '${LIBRARY_HOST_PATH:-./library}:/libraries/books');
...
expectIncludes('deploy/fnos/app/docker/docker-compose.yaml', '${TRIM_DATA_SHARE_PATHS}:/libraries/books');

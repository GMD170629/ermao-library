...
mkdir -p "$MONITOR_ROOT" "$STORAGE_ROOT/database" "$STORAGE_ROOT/covers" "$STORAGE_ROOT/indexes" "$STORAGE_ROOT/conversions" "$STORAGE_ROOT/temp/conversions" "$STORAGE_ROOT/logs" "$STORAGE_ROOT/secrets"

...
- Mobile uses Reader v3 and `volumeId` only. Reader v1/v2, edition APIs, external-source tombstones, OPDS, Web PWA update behavior, and placeholder notes are not Mobile product contracts.

  ...
  return (
    <div className={cardClass}>
      ...
      <div className={compact ? '' : 'mt-5'}>
        {settingRow(i18nAttribute('修正低质量路径信息'), i18nAttribute('默认关闭。关闭本地优先后，仅可修正有来源证据的路径字段；人工保护字段不变。'), <Toggle checked={policy.allowRepairPathMetadata ?? false} label={i18nAttribute('修正低质量路径信息')} onChange={(value) => setPolicy({ ...policy, allowRepairPathMetadata: value })} />)}

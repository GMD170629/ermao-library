...
test('keeps all volume bookmarks together while isolating user, edition and content fingerprint', () => {
  assert.equal(
    readerBookmarkStorageKey('user-1', 'edition-1', null, 'fingerprint-a'),
    readerBookmarkStorageKey('user-1', 'edition-1', 'volume-1', 'fingerprint-a')
  );
  assert.notEqual(
    readerBookmarkStorageKey('user-1', 'edition-1', null, 'fingerprint-a'),
    readerBookmarkStorageKey('user-2', 'edition-1', null, 'fingerprint-a')
  );

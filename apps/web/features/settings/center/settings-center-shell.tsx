    ...
    <div className="min-h-[calc(100vh-9rem)] rounded-[30px] bg-[#FCFBF9] px-5 py-6 text-[#272522] sm:px-7 lg:px-9 lg:py-8">
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
          ...
          <h1 className="truncate text-3xl font-semibold tracking-[-0.035em] text-[#20201F] lg:text-[40px]">设置</h1>
        </div>
      ...
      <div className="mt-9">
        ...
        <main className="mt-8 min-w-0 lg:mt-0">
          <header className="border-b border-[#DEDAD4] pb-5">
            <h2 className="text-2xl font-semibold tracking-[-0.025em] text-[#20201F] lg:text-[30px]">{title}</h2>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-[#77716A]">{description}</p>
          </header>

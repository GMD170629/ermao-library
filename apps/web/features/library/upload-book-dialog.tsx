      ...
      <div className="w-full max-w-xl rounded-3xl border border-black/[0.08] bg-[#FFFEFC] p-6 shadow-[0_28px_80px_rgba(47,37,31,0.22)]">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-1.5 text-sm leading-6 text-[#817B75]"><I18nText>选择一个目录并保存多个图书文件。只有已启用监控的目录才会自动识别。</I18nText></div>
          </div>
        ...
        <div className="mt-6 space-y-4">
          ...
          <TargetDirectoryPicker value={uploadTargetPath} onChange={setUploadTargetPath} memory="upload" label={i18nAttribute('保存目录')} requiredMessage={i18nAttribute('请选择保存目录')} />

...
const exactOverrides = {
  ...
  '取消': 'Cancel',
  '删除': 'Delete',
  '本操作只删除导入任务记录。源文件、转换文件和书库内容都会保留。': 'This removes only the import task record. Source files, converted files, and library content are preserved.',
  '确认删除“{value0}”的导入记录。': 'Delete the import record for “{value0}”?',
  '确认删除所有已选导入记录。': 'Delete all selected import records?',
  '保存': 'Save',
  '创建': 'Create',
  '编辑': 'Edit',
  '搜索': 'Search',

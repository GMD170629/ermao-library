...
const exactOverrides = {
  ...
  '作品信息会应用到这本图书的全部版本和卷册。': 'Work information applies to every version and volume of this title.',
  '读取失败': 'Failed to load',
  '网络错误': 'Network error',
  '暂无数据': 'No data yet',
  '暂无图书': 'No books yet',
  ...
  '{value0} 个版本。目录决定卷册名称与顺序，管理模式只编辑元数据。': '{value0} versions. Directory structure determines volume names and order; management mode edits metadata only.',
  '管理卷册信息': 'Manage volume information',
  '修改卷册元数据': 'Edit volume metadata',

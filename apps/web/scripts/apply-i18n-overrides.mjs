...
const exactOverrides = {
  ...
  '读取卷册内容失败': 'Failed to load volume contents',
  '卷册路径': 'Volume path',
  '卷册显示控制': 'Volume display controls',
  '空文件夹': 'Empty folder',
  '列表显示': 'List view',
  '名称 A–Z': 'Name A–Z',
  '名称 Z–A': 'Name Z–A',
  ...
  '文件类型': 'File type',
  '显示方式': 'View',
  '阅读卷册 {value0}': 'Read volume {value0}',
  '这个卷册文件夹是空的': 'This volume folder is empty',
  '正在加载卷册内容': 'Loading volume contents',
  '最早更新': 'Oldest updated',
  '{value0} 个版本，{value1} 个图书卷': '{value0} versions, {value1} book volumes',
  '{value0} 个图书卷': '{value0} book volumes',
  '版本 {value0}': 'Version {value0}',
  '版本路径': 'Version path',
  '版本与图书卷': 'Versions and book volumes',
  '编辑图书卷': 'Edit book volume',
  '从图书卷内容重新提取或生成封面': 'Extract or regenerate the cover from the book volume',
  '打开版本 {value0}': 'Open version {value0}',
  '当前图书卷': 'Current book volume',
  '第 {value0} 卷': 'Volume {value0}',
  '第 {value0} 卷，收听进度 {value1}%': 'Volume {value0}, listening progress {value1}%',
  '第 {value0} 卷，阅读进度 {value1}%': 'Volume {value0}, reading progress {value1}%',
  '点击查看图书卷': 'Open to view book volumes',
  '该版本还没有可见图书卷': 'This version has no visible book volumes yet',
  '管理图书卷': 'Manage book volume',
  '内容大小': 'Content size',
  '内容类型': 'Content type',
  '识别所选图书卷的出版元数据': 'Identify publication metadata for the selected book volume',
  '图书卷显示控制': 'Book volume display controls',
  '图书卷信息已保存': 'Book volume details saved',
  '修改所选图书卷的出版元数据': 'Edit publication metadata for the selected book volume',
  '正在加载图书卷': 'Loading book volumes',
  '修改所选版本的标题、简介和封面': 'Edit the title, description, and cover of the selected version',
  '从版本中的图书卷重新提取或生成封面': 'Extract or regenerate the cover from a book volume in this version',
  '识别元数据': 'Identify metadata',
  '从元数据来源搜索并应用版本信息': 'Search metadata sources and apply version details',
  '重新扫描文件': 'Rescan files',
  '重新扫描该版本下的文件变化': 'Rescan file changes under this version',
  '版本信息已保存': 'Version details saved',
  '编辑版本': 'Edit version',
  '找到 {value0} 条候选': 'Found {value0} candidates',
  '没有找到候选': 'No candidates found',
  '元数据识别失败': 'Metadata identification failed',
  '识别结果已应用到版本': 'The identified metadata was applied to the version',
  '识别版本元数据': 'Identify version metadata',
  '识别关键词': 'Identification keywords',
  '应用': 'Apply',
  '管理版本': 'Manage version',
  '该版本还没有可生成封面的图书卷': 'This version has no book volume available for cover generation',
  '已加入重新扫描队列': 'Added to the rescan queue',
  '图书目录缺少当前节点': 'The book folder response is missing its current node',
  '版本标题不能为空': 'Version title cannot be empty',
  ...
  '未单独设置时沿用图书卷或图书封面': 'Uses the book volume or book cover when no custom cover is set',
};

...
class WarmPageComponentMetricsTest {
    ...
    fun androidComponentGeometryHasOneNamedSource() {
        ...
        assertEquals(28.dp, metrics.settings.iconSlotSize)
        assertEquals(20.dp, metrics.settings.iconSize)
        assertEquals(12.dp, metrics.settings.iconTitleSpacing)
        assertEquals(18.dp, metrics.settings.trailingSlotWidth)
        assertEquals(20.dp, metrics.settings.sectionSpacing)
        assertEquals(8.dp, metrics.settings.sectionHeaderBottomSpacing)
        assertEquals(52.dp, metrics.settings.identityAvatarSize)
        assertEquals(76.dp, metrics.settings.identityMinimumHeight)
        assertEquals(50.dp, metrics.settings.bottomActionHeight)

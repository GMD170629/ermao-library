...
import com.ermao.library.features.downloads.downloadManagementActionIcon
...
private fun DownloadResourceRow(
    ...
    com.ermao.library.features.downloads.DownloadResourceRow(
        resource.id, resource.title, resource.format, resource.sizeBytes, management, record,
        depth, selectionMode, selected, isSubmitting, onToggleSelection, onSubmitAction, onRequestRemoval, onOpenDownloaded,
        displayTitle = DownloadManagementPolicy.displayTitle(bookTitle, resource.title),
    )
}

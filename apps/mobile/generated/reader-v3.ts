...
export type ErrorEnvelope_ReaderErrorBody_ = {
  ok?: false;
...
export type ReaderBookmarksData = {
  bookmarks: ReaderBookmark_Output[];
};

export type ReaderBookmarksReplaceRequest = {
  contentFingerprint: string;
  bookmarks: ReaderBookmark_Input[];
};
...
export type ReaderBootstrapData = {
  ...
  availableVolumes: ReaderVolumeSummary[];
  files: ReaderFileSummary[];
...
} | ReaderJsonValue_Input[] | string | number | number | boolean | null;

export type ReaderJsonValue_Output = {
  [key: string]: ReaderJsonValue_Output;
} | ReaderJsonValue_Output[] | string | number | number | boolean | null;

"""Merge unfinished image-page work into the existing resource queue."""

import sqlalchemy as sa
from alembic import op

revision = "0013_image_resource_tasks"
down_revision = "0012_resource_import_tasks"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    raise RuntimeError("Restore the pre-upgrade backup to downgrade image imports")

...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["resourceId"], ["LibraryReadableResource.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("updatedAt", sa.BigInteger(), nullable=False),
        sa.ForeignKeyConstraint(
            ["assetId"], ["LibraryResourceAsset.id"], onupdate="CASCADE", ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["resourceId"], ["LibraryReadableResource.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
    ...
    with op.batch_alter_table("ReadableResourceNavigationUnit", schema=None) as batch_op:
        batch_op.create_index(
    ...
    with op.batch_alter_table("ReaderProgressCursor", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_ReaderProgressCursor_resourceId"), ["resourceId"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["resourceId"], ["LibraryReadableResource.id"], onupdate="CASCADE", ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["bookId"], ["LibraryBook.id"], onupdate="CASCADE", ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.Column("updatedAt", sa.BigInteger(), nullable=False),
        sa.ForeignKeyConstraint(
            ["importTaskId"], ["LibraryImportTask.id"], onupdate="CASCADE", ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
    ...
    with op.batch_alter_table("OrganizeJob", schema=None) as batch_op:
        ...
        batch_op.create_index("OrganizeJob_resourceId_idx", ["resourceId"], unique=False)
        batch_op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["assetId"], ["LibraryResourceAsset.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["resourceId"], ["LibraryReadableResource.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),

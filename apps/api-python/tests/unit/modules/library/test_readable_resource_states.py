...
def test_meets_minimum_ready_assets() -> None:
    assert meets_minimum_ready_assets(ready_asset_count=0, minimum_ready_assets=1) is False
    assert meets_minimum_ready_assets(ready_asset_count=1, minimum_ready_assets=1) is True
    assert meets_minimum_ready_assets(ready_asset_count=3, minimum_ready_assets=2) is True
    assert meets_minimum_ready_assets(ready_asset_count=1, minimum_ready_assets=2) is False
